...
client.on('message', msg => {
    if (msg.content === 'sk.xanthippe') {
    	msg.reply('my gun says: \n **Xanthippe** \n \n **Altar of Misery - cd 66s** \n Level 1 |**6**: \n :white_small_square:[Regular Damage]: Deal damage equal to 166.2% | **232.7%** of ATK to 3 enemies | **4 enemies**. \n :white_small_square:[Debuff]: Has a 50% chance of Marking a target (Mark disappears after 40s, dealing damage equal to 41.3% | **48.7%** of ATK). \n :white_small_square:[Chain Attack]: Deal damage equal to 176.4% | **247%** of ATK to 3 | **4** Marked enemies. \n :white_small_square:[Chain Effect]: Heal HP of 3 | **4** allies for 132.7% | **172.5%** of ATK when chain attack is triggered). \n :white_small_square:[Chain Effect]: Mark disappears, immediately inflicting Mark DMG when chain attack is triggered. \n \n **Hammer of Judgement - cd 100s** \n Level 1 | **6**: \n :white_small_square:[Regular Damage]: Deal damage equal to 150.9% | **202.1%** of ATK to 4 | **5** enemies. \n :white_small_square:[Debuff]: Has a 50% chance of Marking targets (Mark disappears after 40s, dealing damage equal to 52.1% | **61.5%** of ATK). \n :white_small_square:[Chain Attack]: Deal damage equal to 187.1% | **262%** of ATK to 4 | **5** enemies (Marked enemies trigger chain attacks). \n :white_small_square:[Chain Effect]: Decrease ATK of Hit Targets by 26.8% | **30.2%** when chain attack is triggered (Duration:60s). \n :white_small_square:[Chain Effect]: Mark disappears, immediately inflicting Mark DMG when chain attack is triggered.');
  	}
});
